...
```{r}
fig5c_nonmatch <- ggplot(fig5c_data_nonmatch, aes(x = Inducer, y = cen_per, shape = scored_chrom_aneuploid, color = Non_inducer)) +
  geom_quasirandom() +
  labs(x = "Haploid Inducer", y = "% H' allele", color = "Tetraploid Parent", shape = "Assayed Chrom. Aneuploidy") +
  scale_y_continuous(limits = c(0,100)) +
  # guides(shape = F) +
  theme_bw() +
  theme(legend.position = c(0.354, 0.828),
...
```{r}
fig5c_match <- ggplot(fig5c_data_match, aes(x = Inducer, y = cen_per, shape = scored_chrom_aneuploid, color = Non_inducer)) +
  geom_quasirandom(size = 0.9) +
  labs(x = "Haploid Inducer", y = "% H' allele", shape = "Assayed Chrom. Aneuploidy", color = "Tetraploid Parent") +
  scale_y_continuous(limits = c(0,100)) +
  theme_bw() +
  theme(legend.position = c(0.354, 0.174),
        legend.justification = "left",
        legend.title = element_text(size = 6, face = "bold"),
        legend.title.align = 0.5,
        legend.text = element_text(size = 6),
